...
\input{Chapter1} % The Backstory of PaB; it's a summary with citations of stuff to study later. Details will be in the appendix if I'm expected to write them up.

%\input{Chapter2} % The action of GT^ on PaB
