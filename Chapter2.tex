...
\begin{definition}[planar operad, symmetric operad]
	...
	such that 1. and 2. of following are satisfied. If each object $P(n)$ has a right $S_n$-action ($S_n$ being the $n$th symmetric group), and 3. is staisfied, then $P$ is a \emph{symmetric operad}
	\begin{enumerate}
...
\end{remark}
\begin{definition}[(braided) operad morphism]
	A morphism $f:P\to Q$ of braided operads is a collection of maps $\left\{ f_n:P(n)\to Q(n) \right\}_{n}$ such that
\end{definition}