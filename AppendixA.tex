...
\textbf{Key references}: The operadic realization of the Teichm\"uller tower is explained in Hatcher-Lochak-Schneps, “On the Teichm\"uller tower of mapping class groups,” J. Reine Angew. Math. 521 (2000), and in lecture notes by Borghi-Robertson \cite{Borghi_Robertson_2025}. The work of Boavida de Brito-Horel-Robertson (2020) establishes rigorously that $\widehat{\mathsf{GT}}$ equals the automorphism group of the profinite little-disks operad \cite{de_Brito_Horel_Robertson_2019}. Finally, the fact that $E_2(n)$ is $K(\pi,1)$ with $\pi$ a braid group is classical \cite{C_2014}. These and other sources give a thorough account of how $\pi_1(E_2)$ encodes the genus-zero Grothendieck-Teichm\"uller structures.